...
use Yii;
use app\models\PpRelacionesExt;
...
/**
 * PpRelacionesExtController implements the CRUD actions for PpRelacionesExt model.
 */
class PpRelacionesExtController extends Controller {
    ...
    public function ifcanIndex($action, &$nivel, $model = null) {
        ...
        $puede = Vpermisos::findBySql(
                        ...
                        . ' and ( permi_metodo = :action or permi_metodo = ' . "'*'" . ')', ['clase' => 'PpRelacionesExt',
                    'usr' => $usr,
                    'action' => $action])->all();
        $r = false;
        if (sizeof($puede) > 0) {
...
//$dataProvider->query->andFilterWhere(['event_id' => $id,]);
    ...
    /**
     * Lists all PpRelacionesExt models.
     * @return mixed
     */
    ...
    /**
     * Displays a single PpRelacionesExt model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new PpRelacionesExt model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate() {
        $this->can('create');
        $model = new PpRelacionesExt();
    ...
    /**
     * crea en batch nuevosPpRelacionesExt modelos hijos de una table.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
...
// si se de dar d alta al registro uno no se ha registrado ninguno mandar error
            ...
            if ($model->save()) {
                return $this->redirect(['PpRelacionesExt/add', 'regis' => $ri]);
            } else {
...
// es redundante pero previene algun error
    ...
    /**
     * Updates an existing PpRelacionesExt model.
    ...
    /**
     * Deletes an existing PpRelacionesExt model.
    ...
    /**
     * Finds the PpRelacionesExt model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return PpRelacionesExt the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id) {
        if (($model = PpRelacionesExt::findOne($id)) !== null) {
            return $model;
        }
